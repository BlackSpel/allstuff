...
<table style="border: 1px solid #ddd; border-collapse: collapse; width: 100%;">
  ...
  <?php endforeach;?>
  <tr>
    <td colspan="3" style="padding: 8px; border: 1px solid #ddd;">Items:</td>
  ...
  <tr>
    ...
    <td style="padding: 8px; border: 1px solid #ddd;"><?= $_SESSION['cart.currency']['symbol_left'] . $_SESSION['cart.sum'] ?></td>
  </tr>
  </tbody>
</table>
